export const USERS_MESSAGES = {
  ...
  PASSWORD_MUST_BE_STRONG: 'Password must be 6-50 characters long and contain at least 1 lowercase letter, 1 uppercase letter, 1 number, and 1 symbol',
  ...
  USERSNAME_MUST_BE_STRING: 'Username must be string',
  USERSNAME_LENGTH: 'Usersname length must be from 1 to 200',
  IMAGE_URL_MUST_BE_STRING: 'Cover photo must be string',
  IMAGE_URL_LENGTH: 'Cover photo length must be from 1 to 400',
  UPDATE_ME_SUCCESS: 'Update me success',
  GET_PROFILE_SUCCESS: 'Get profile success',
  FOLLOW_SUCCESS: '!uccess',
  INVALID_USER_ID: 'Invalid user id',
  FOLLOWED: 'Followed',
  ALREADY_UNFOLLOWED: 'Already unfollowed',
  UNFOLLOWED_SUCCESS: 'Unfollowed success',
  USERSNAME_INVALID: 'Usersname must be 4-15 characters long and contain only letters, numbers, underscores, not only numbers',
